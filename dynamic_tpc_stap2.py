...
dag = DAG(f'Dynamic_{MDP_APPLICATION}_stap2_ingest_into_raw',
          default_args=default_args,
          description=f'Dynamically generated {MDP_APPLICATION} load from bucket into datawarehouse layer Raw',
